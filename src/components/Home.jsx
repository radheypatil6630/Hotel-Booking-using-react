...
const Home = () => {
  ...
  //           <img className='lg:w-2/3 lg:h-[300px] md:w-2/4 md:h-[200px] p-2 shadow-lg shadow-black' src={room_img} />
  ...
  return (
    <div>
      ...
      <div className="flex flex-col md:flex-row h-auto md:h-[700px]">
        {/* <div className="relative w-full  md:w-1/2 md:h-[700px] flex flex-col bg-[#0d4a4e] items-center justify-center gap-3 sm:gap-4 text-white p-4 sm:p-6  md:p-8 text-center ">
          ...
          <div className='flex flex-wrap justify-evenly gap-2 '>
            ...
            <div className='text-white font-semibold text-sm md:text-md px-2 py-1 rounded-lg hover:underline transition duration-300 flex items-center gap-2 cursor-pointer justify-center'>
              <FontAwesomeIcon icon={faLocation} className="w-5 h-5 md:w-6 md:h-6 rounded-full bg-white text-red-500 p-1" />
              Watch Hilton View
            </div>
          </div>


          <div className="absolute left-2 sm:left-4 bottom-2 sm:bottom-4 flex gap-1 sm:gap-2 text-[10px] sm:text-xs md:text-sm">
            <img
              src={room_img}
              alt="Gym"
      ...
      <div className="flex flex-col lg:flex-row p-4 sm:p-6 md:p-12 gap-4 lg:gap-2">
        ...
        {/* <div className="relative w-full md:w-1/3 lg:w-1/4 rounded-xl mt-4 md:mt-0">
          <img
            className="w-full h-[180px] sm:h-[220px] md:h-[300px] object-cover rounded-xl shadow-[2px_2px_0px_rgba(0,0,0,0.2)] shadow-black"
            src={room_img}
            alt="Main"
          />
          <img
            className="w-[120px] h-[150px] sm:w-[150px] sm:h-[180px] md:w-[200px] md:h-[250px] object-cover rounded-lg absolute bottom-6 sm:bottom-10 md:bottom-20 left-0 border-2 border-white shadow-lg shadow-black"
            src={room_img}
            alt="Overlay"
          />
        </div> */}
